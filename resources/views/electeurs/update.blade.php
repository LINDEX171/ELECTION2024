...
<div class="container mt-5">
  <h2 class="mb-4">Modifier electeur</h2>
  <form id="awesomeForm" action="storeelecteurs"  enctype="multipart/form-data"  method="post">
    @csrf

    <input type="text" name="id" style="display: none;" value="{{ $electeur->id }}">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="" name="Prenom" placeholder="Entrez votre prenom" value="{{ $electeur->Prenom }}" required>
    </div>
    <div class="form-group">
        <label for="CNI">Téléchargez votre photo de CNI :</label>
        <input type="file" class="form-control-file" id="" name="CNI"accept="image/* value="{{ $electeur->CNI }}" required>
    </div>
    <div class="form-group">
        <label for="Adresse">Adresse :</label>
        <input type="text" class="form-control" id="" name="Adresse" placeholder="Entrez votre Adresse" value="{{ $electeur->Adresse }}" required>
    </div>

    <div class="form-group">
        <label for="candidat_id">Choisir un candidat :</label>
        <select name="candidat_id" class="form-control">
            <option value="" selected disabled value="{{ $electeur->Prenom }}">Sélectionnez un candidat</option>
